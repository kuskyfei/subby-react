...
class Header extends React.Component {
  ...
  componentDidMount() {
    // this is because material UI inputs don't allow
    // passing down the size attribute which is needed
    // to make the search bar responsive for small
    // screens.
    document.querySelector('#header__search-bar').size = 1
  }
